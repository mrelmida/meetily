  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-2 p-2 bg-blue-50 dark:bg-blue-950/40 rounded border border-blue-200 dark:border-blue-900">
          ...
          <div className="text-xs text-blue-700 dark:text-blue-400">
            ...
            <button
              ...
              className="text-blue-600 dark:text-blue-400 hover:text-blue-800 underline hover:no-underline"
            >
              View Privacy Policy
            </button>
          </div>
