  ...
  return (
    <Dialog aria-describedby={undefined}>
      {isCollapsed ? (
        ...
        <DialogTrigger asChild>
          <span className="text-lg text-center border rounded-full bg-primary/10 border-border font-semibold text-primary mb-2 block items-center cursor-pointer hover:opacity-80 transition-opacity">
            <span>Meetily</span>
          </span>
        </DialogTrigger>
      )}
