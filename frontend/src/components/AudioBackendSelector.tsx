...
export function AudioBackendSelector({
  ...
  return (
    <div className="space-y-2">
      ...
      {error && (
        <div className="p-2 text-xs text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-900 rounded-md">
          {error}
        </div>
      )}
          ...
          return (
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-blue-600 dark:text-blue-400 focus:ring-blue-500 border-border"
              />
              <div className="ml-3 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  {currentBackend === backend.id && (
                    <span className="text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-500/15 px-2 py-0.5 rounded">
                      Active
                    </span>
                  )}
                  {isCoreAudio && (
