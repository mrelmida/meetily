        ...
        <div className="flex flex-col items-center space-y-4 mt-4">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                onClick={() => router.push('/')}
                className={`p-2 rounded-lg transition-colors duration-150 ${isHomePage ? 'bg-accent text-accent-foreground' : 'hover:bg-accent hover:text-accent-foreground'
                  }`}
              >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className="p-2 rounded-lg transition-colors duration-150 bg-primary/10 text-primary hover:bg-primary/20"
                >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${isMeetingPage ? 'bg-accent text-accent-foreground' : 'hover:bg-accent hover:text-accent-foreground'
                  }`}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-150 ${isSettingsPage ? 'bg-accent text-accent-foreground' : 'hover:bg-accent hover:text-accent-foreground'
                  }`}
              >
                ...
                {isMeetingItem && (
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                    ...
                    <button
                      ...
                      className="hover:text-red-600 p-1 rounded-md hover:bg-red-50 dark:hover:bg-red-500/10 flex-shrink-0"
  ...
  return (
    <div className="fixed top-10 left-0 h-[calc(100vh-2.5rem)] z-40">
      ...
      <button
        ...
        className="absolute -right-6 top-20 z-50 p-1 bg-card hover:bg-accent rounded-full shadow-lg border border-border text-foreground"
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-shrink-0">
            {!isCollapsed && (
              <div
                onClick={() => router.push('/')}
                className="p-3 text-lg font-semibold items-center hover:bg-accent hover:text-accent-foreground h-10 flex mx-3 mt-3 rounded-lg cursor-pointer transition-colors"
              >
        ...
        {!isCollapsed && (
          ...
          <div className="flex-shrink-0 p-2 border-t border-border">
            ...
            {betaFeatures.importAndRetranscribe && (
              <button
                onClick={() => openImportDialog()}
                className="w-full flex items-center justify-center px-3 py-2 mt-1 text-sm font-medium text-primary bg-primary/10 hover:bg-primary/20 rounded-lg transition-colors shadow-sm"
              >
